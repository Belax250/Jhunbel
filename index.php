  ...
  <section id="photos">
    ...
    <div class="photos-gallery">
      <div class="photo-card">
        <img src="images/photos/photo1.jpg" alt="Photo 1" onerror="this.style.display='none'; this.parentElement.innerHTML='<div style=\'padding: 2rem; text-align: center; color: #666;\'>Photo 1<br><small>Add photo1.jpg to images/photos/</small></div>'">
      </div>
      <div class="photo-card">
        <img src="images/photos/photo2.jpg" alt="Photo 2" onerror="this.style.display='none'; this.parentElement.innerHTML='<div style=\'padding: 2rem; text-align: center; color: #666;\'>Photo 2<br><small>Add photo2.jpg to images/photos/</small></div>'">
      </div>
      <div class="photo-card">
        <img src="images/photos/photo3.jpg" alt="Photo 3" onerror="this.style.display='none'; this.parentElement.innerHTML='<div style=\'padding: 2rem; text-align: center; color: #666;\'>Photo 3<br><small>Add photo3.jpg to images/photos/</small></div>'">
      </div>
      <div class="photo-card">
        <img src="images/photos/photo4.jpg" alt="Photo 4" onerror="this.style.display='none'; this.parentElement.innerHTML='<div style=\'padding: 2rem; text-align: center; color: #666;\'>Photo 4<br><small>Add photo4.jpg to images/photos/</small></div>'">
      </div>
      <div class="photo-card">
        <img src="images/photos/photo5.jpg" alt="Photo 5" onerror="this.style.display='none'; this.parentElement.innerHTML='<div style=\'padding: 2rem; text-align: center; color: #666;\'>Photo 5<br><small>Add photo5.jpg to images/photos/</small></div>'">
      </div>
    </div>
  </section>
